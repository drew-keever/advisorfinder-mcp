...
Data is sourced from the **SEC Investment Adviser Public Disclosure (IAPD)** database and refreshed periodically — use the get_database_stats tool to see the current data_as_of date.
